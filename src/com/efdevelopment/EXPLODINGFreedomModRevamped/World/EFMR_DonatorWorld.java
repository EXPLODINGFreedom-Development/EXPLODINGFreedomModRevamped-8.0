...
public final class EFMR_DonatorWorld extends TFM_CustomWorld
{
    ...
    public static EFMR_DonatorWorld getInstance()
    {
        return EFMR_DonatorWorldHolder.INSTANCE;
    }

    private static class EFMR_DonatorWorldHolder
    {
        private static final EFMR_DonatorWorld INSTANCE = new EFMR_DonatorWorld();
    }
}