...
public class Command_historyworld extends TFM_Command
{
    @Override
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        {
            TFM_HistoryWorld.getInstance().sendToWorld(sender_p);
            sender.setOp(true);
            sender_p.setGameMode(GameMode.CREATIVE);
            playerMsg("Going to the §eHistory§7 world back in late 2014...");
        }
        else
        {
