...
public class TFM_HistoryWorld extends TFM_CustomWorld
{
    private static final String GENERATION_PARAMETERS = TFM_ConfigEntry.FLATLANDS_GENERATE_PARAMS.getString();
    private static final String WORLD_NAME = "historyworld";

    private TFM_HistoryWorld()
    {
    }
    ...
    protected World generateWorld()
    {
        ...
        welcomeSign.setLine(0, ChatColor.GREEN + "History World");
    ...
    public static TFM_HistoryWorld getInstance()
    {
    ...
    {
        private static final TFM_HistoryWorld INSTANCE = new TFM_HistoryWorld();
    }
}
